...
class ControleDespesasApp:
    def __init__(self, root):
        ...
        opcoes_menu.add_command(label="Cadastro", command=self.abrir_tela_cadastro)
        opcoes_menu.add_command(label="Relatório", command=self.abrir_tela_relatorio)
        #opcoes_menu.add_command(label="Edição", command=self.abrir_tela_edicao)
        opcoes_menu.add_separator()
        opcoes_menu.add_command(label="Sair", command=self.sair)
